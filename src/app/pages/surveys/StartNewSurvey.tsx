...
import { ArrowNarrowLeft, ArrowNarrowRight, BuildingComunity, CheckboxIcon, ClearAllIcon, PlusIcon, SaveIcon, XIcon } from '../../../infraestructure/components/icons';
                ...
                >
                    {
                        areasWithDatetime?.map((area) => (
                            <div className="shadow-emerald-600/10 shadow-xl rounded-xl py-5 px-2 cursor-pointer flex items-center border-2 border-slate-200 hover:border-emerald-600 tarnsition-all duration-300 ease-in-out w-full my-2 animate-[fadeIn_0.5s] max-h-[6rem] relative [&>*:first-child>*:first-child]:hover:bg-danger"
                                key={area?.id}
                            >
                                <div>
                                ...
                                <div className="relative w-full [&>b]:text-[10px] [&>b]:text-emerald-600">
