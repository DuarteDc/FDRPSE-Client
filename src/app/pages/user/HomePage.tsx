        ...
        <div className="w-full flex justify-center items-center">
            <div className="grid lg:grid-cols-7 py-5 lg:py-20 max-w-[2000px]">
                <div className="flex flex-col justify-center col-span-3">
                    <h1 className="text-7xl font-bold lg:mb-10">Hola <b className="text-emerald-600">{`${user?.name} ${user?.lastName}`}</b></h1>
                    <span className="lg:hidden mx-auto">
                        <img src="/assets/question-home.svg" alt="home-icon" loading="lazy" width="500" height="200" />
                    </span>
