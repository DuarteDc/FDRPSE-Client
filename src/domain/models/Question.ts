...
export class Question implements QuestionSchema {
    ...
    constructor(id: string, name: string, type: TypeQuestion,  createdAt: string, updatedAt: string, section ?: SectionResponseDto, category ?: CategoryResponseDto, qualification ?: QualificationResponseDto, dimension?: DimensionResponseDto, domain?: DomainResponseDto ) {
        this.id             = id;
        this.name           = name;
        this.type           = type;
        this.section        = section ? new Section(section.id, section.name, section.question, section.binary, section.questions_count, section.created_at, section.updated_at) : null;
