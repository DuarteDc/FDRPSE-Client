                                ...
                                <div className="border-2 max-h-[200px] rounded-lg p-4 overflow-x-auto">
                                    {
                                        section!.questions.map((question) => (
                                            <span className="flex items-center font-bold text-xs [&>svg]:border-2 [&>svg]:rounded-full
                        [&>svg]:text-emerald-600 p-1 [&>svg]:mr-2 cursor-pointer hover:bg-gray-100 transition-all duration-400 rounded-lg
                        
                        " key={question.id} aria-label={question.name} title={question.name}>
